...
| **Ed Yun** | **3D neighbor visualization (capstone)** — Plotly scatter3d, merge/dedupe logic, distance metric (energy + valence + normalized tempo), search UI, neighbor list | Energy/mood testing, axis/zoom behavior, mobile layout checks, README technical sections |
